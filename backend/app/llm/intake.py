...
when they say being near their favourite places matters), and for RENT searches only: \
furnished, unfurnished (chain_free is for BUY searches only). If the user names a specific \
